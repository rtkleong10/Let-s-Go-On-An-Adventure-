...
addSource(hoverBeep, 'http://soundimage.org/wp-content/uploads/2016/04/UI_Quirky29.mp3');
hoverBeep.appendTo("body");

var clickBeep = $("<audio id='click-beep'/>");
addSource(clickBeep, 'http://soundimage.org/wp-content/uploads/2016/04/UI_Quirky19.mp3');
